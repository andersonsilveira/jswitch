...
public class JCheckBoxMenuItemGroupListener implements ItemListener {
    ...
    private static final String ERRO_DURING_CONFIG = bundle.getString("error.config");

    public JCheckBoxMenuItemGroupListener(JSwitchManager operationSystemManager, TrayIcon icon) {
	super();
    ...
    JSwitchManager operationSystemManager;
	...
	if (e.getStateChange() == ItemEvent.SELECTED) {
		...
		icon.displayMessage("Atenção", itemAffected + ERRO_DURING_CONFIG, TrayIcon.MessageType.ERROR);
	    }
